...
import { ArrowRight, CircleAlert, GitFork, Pencil, Users } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <CardFooter className="p-0 mt-4 gap-2 flex justify-end">
        <Link
          href={`/maintainer/projects/${project.project_id}`}
          className="flex-1"
        >
          <Button className="w-full text-sm cursor-pointer" variant="outline">
        ...
        {isOwner && (
          <Button
            ...
            onClick={() => {
              setProject(project);
              router.push("/maintainer/projects/management?mode=edit");
            }}
          >
