    ...
    <Card className="relative overflow-hidden group w-full md:w-3/12">
      ...
      <div className="p-5">
        <div className="flex items-center justify-between">
          ...
          <NumberTicker value={publicRepos} className="text-xl font-semibold" />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <NumberTicker value={followers} className="text-xl font-semibold" />
        </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <NumberTicker value={following} className="text-xl font-semibold" />
        </div>
      </div>
    </Card>
  );
