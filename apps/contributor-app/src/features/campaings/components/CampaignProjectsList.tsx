      ...
      {projects.length > 0 ? (
        projects.map((proj) => (
          <Link
            ...
            key={proj.project_id}
          >
            <div className="relative rounded-2xl border p-5 bg-gradient-to-b from-background/40 to-background/10 hover:from-accent/10 hover:to-transparent transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5 group overflow-hidden">
              <ShineBorder
